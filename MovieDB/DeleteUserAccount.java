...
public class DeleteUserAccount extends JFrame implements ActionListener{
    ...
    DeleteUserAccount(){
        ...
        l1 = new JLabel("Enter the User ID to Delete the ROW");
    ...
    public void actionPerformed(ActionEvent ae){
        try{        
            if(ae.getSource()==b1){
                ...
                String q1 = "delete from login where user_id = '"+user_id+"'";
                c1.s.executeUpdate(q1);
                JOptionPane.showMessageDialog(null, "User's data has been deleted");
            }
            if(ae.getSource()==b2){
                tf1.setText("");
            }
