...
public class DataBaseInfo extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        try{        
            if(ae.getSource()==b1){
                ...
                String q1 = "insert into Movie values('"+mov_id+"','"+mov_title+"','"+mov_year+"','"+mov_lang+"','"+mov_country+"','"+mov_duration+"')";
                c1.s.executeUpdate(q1);  
                JOptionPane.showMessageDialog(null, "The data has been successfully inserted");
            }
            if(ae.getSource()==b2){
                tf1.setText("");
                tf2.setText("");
